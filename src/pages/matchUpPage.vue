    ...
    <Loading :state="requestState" message="Loading Player Data" size="lg">
      ...
      <div class="opponent-container">
        ...
        <div id="learnMore" class="collapse">
          <div>
            In this tool, you can add an ally code of an opponent. Most often
            this will be for GAC but can also be used for Squad Arena or
            Territory Wars.
          </div>
          <div>
          ...
          <div>
            ...
            <ul>
              <li>
                Omicron Abilities are always applied if the game mode is
                selected, even if the unit doesn't have it applied. A future
                version of the tool will make adjustments accordingly.
              </li>
              <li>
