export default {
  aquisition: {
    "108Salvage": {
      ...
      conquest: {
        hard: {
          box7: calculateConquest(30, 9, 1),
          box6: calculateConquest(30, 9, 1),
          box5: calculateConquest(30, 9, 1),
          box4: calculateConquest(30, 9, 1),
          box3: calculateConquest(30, 9, 1),
          box2: calculateConquest(30, 9, 2),
          box1: calculateConquest(30, 9, 2),
        },
        normal: {
          box7: calculateConquest(30, 9, 2),
          box6: calculateConquest(30, 9, 2),
          box5: calculateConquest(30, 9, 2),
          box4: calculateConquest(30, 9, 3),
          box3: calculateConquest(30, 9, 3),
          box2: calculateConquest(30, 9, 2),
          box1: calculateConquest(30, 9, 1),
        },
      },
      gc: {
    ...
    "135Salvage": {
      ...
      conquest: {
        ...
        normal: {
          ...
          box4: calculateConquest(30, 9, 3),
          box3: calculateConquest(30, 9, 3),
          box2: calculateConquest(30, 9, 2) + calculateConquest(15, 12, 1),
          box1: calculateConquest(30, 9, 1) + calculateConquest(15, 12, 2),
        },
      },
      gc: {
        box10: calculateGC(10, 2, 9),
    ...
    "143Salvage": {
      ...
      conquest: {
        normal: {
          box2: calculateConquest(15, 12, 1),
          box1: calculateConquest(15, 12, 2),
        },
      },
      gc: {
    ...
    "171PrototypeSalvage": {
      ...
      conquest: {
        hard: {
          box7: calculateConquest(15, 12, 1),
          box6: calculateConquest(15, 12, 1),
          box5: calculateConquest(15, 12, 2),
          box4: calculateConquest(15, 12, 2),
          box3: calculateConquest(15, 12, 2),
          box2: calculateConquest(15, 12, 2),
          box1: calculateConquest(15, 12, 2),
        },
        normal: {
          box7: calculateConquest(15, 12, 2),
          box6: calculateConquest(15, 12, 3),
          box5: calculateConquest(15, 12, 3),
          box4: calculateConquest(15, 12, 2),
          box3: calculateConquest(15, 12, 1),
        },
      },
      gc: {
    ...
    "174Ingredient_Salvage": {
      ...
      conquest: {
        hard: {
          box7: calculateConquest(25, 3, 1),
          box6: calculateConquest(25, 3, 1),
          box5: calculateConquest(25, 3, 1),
          box4: calculateConquest(25, 3, 1),
          box3: calculateConquest(25, 3, 1),
          box2: calculateConquest(25, 3, 2),
          box1: calculateConquest(25, 3, 2),
        },
        normal: {
          box7: calculateConquest(25, 3, 2),
          box6: calculateConquest(25, 3, 2),
          box5: calculateConquest(25, 3, 2),
          box4: calculateConquest(25, 3, 1),
        },
      },
      gc: {
