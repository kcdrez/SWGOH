const scavengerFarming = [
  {
    ...
    gear: [
      ...
      //   notes:
      //     "Not recommended as the ratio is poor compared to other gear from the Guild Store, but can be used in a pinch. Recommended to save 20-30 in reserves.",
      // },
      {
        id: "078",
        scavenger: ["chromium_transistor"],
      ...
      {
        id: "049",
        scavenger: ["chromium_transistor", "bronzium_wiring"],
        notes:
          "Recommended to save 100-200 in reserves. Used to craft Mk 7 Fabritech Data Pad for Chromium Transistors. Can also be used to craft Bronzium Wirings if needed.",
      },
      {
        id: "102Salvage",
  ...
  },
  {
    ...
    gear: [
      ...
      {
        id: "030",
        scavenger: ["chromium_transistor", "carbonite_circuit_board"],
        notes:
          "Can also be used for Carbonite Circuit Boards, but it's recommended to use these to craft Mk 7 BAW Armor Mod for Chromium Transistors.",
      },
    ],
  },
  {
